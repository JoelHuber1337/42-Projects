...
/*   Updated: 2025/12/17 21:35:57 by johuber          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	...
	this->ep = 10;
	this->ad = 0;
	std::cout << "\033[0;38;2;187;161;79;49mClapTrap " << name << " has been created\033[0m\n";
}
...
{
	std::cout << "ClapTrap Argument Constructor has been called\n";
	this->name = name;
	this->hp = 10;
	this->ep = 10;
	this->ad = 0;
